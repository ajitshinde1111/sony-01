...
ChatGPT said:
Ajit, तू दिलेला app.py कोड योग्य दिशेने आहे, पण त्यात काही duplicate आणि non-standard भाग आहेत (उदा. दोनदा app = Flask(__name__), दोन वेळा MongoClient etc.), आणि Render साठी काही बदल करणे आवश्यक आहे.

✅ Final Render-Compatible Clean Version of app.py
python
Copy
Edit
from flask import Flask, request, send_from_directory, redirect
